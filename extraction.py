...
#text = (u"Bill is cool. He has a sister named Sally May, who is a fast runner.")
#text = wiki_to_string()
...
for token in doc:
    ...
    elif len(verb) == 0 and len(obj) == 0 and (token.pos_ == "PROPN" or token.pos_ == "PRON" or token.pos_ == "NOUN"):
        sub += [str(token)]
